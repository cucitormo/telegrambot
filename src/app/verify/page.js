...
export default function VerifyPage() {
    ...
    const handleVerify = async () => {
        ...
        try {
            ...
            if (status === 'success') {
                ...
                // Simpen sessionnya sendiri nih sayang~
                localStorage.setItem('telegramSession', data.session);

                // Nah ini user detailnya disimpen sendiri juga~
    ...
    const handlePasswordVerify = async () => {
        ...
        try {
            ...
            if (status === 'success') {
                setMessage('✅ Yeay~ Login sukses! Kamu jago banget deh 💖');
                ...
                // Udah beres, langsung pindah ke dashboard biar bisa pilih-pilih channel manja gitu~
                router.push('/dashboard');
            } else {
